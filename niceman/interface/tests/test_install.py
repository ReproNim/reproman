...
def test_install_interface(demo1_spec, niceman_cfg_path):
    ...
    with patch('docker.Client') as client, \
        ...
        calls = [
            ...
            call().exec_create(cmd="grep -q 'deb http://snapshot.debian.org/archive/debian/20171208T032012Z/ sid main contrib non-free' /etc/apt/sources.list.d/niceman.sources.list", container={'Id': '326b0fdfbf838', 'Names': ['/my-resource'], 'State': 'running'}),
