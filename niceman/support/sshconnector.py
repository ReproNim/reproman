...
# on initial import niceman time
# from niceman.support.network import RI, is_ssh

from niceman.support.exceptions import CommandError
from niceman.dochelpers import exc_str
from niceman.utils import not_supported_on_windows
from niceman.utils import on_windows
from niceman.utils import assure_dir
from niceman.utils import auto_repr
from niceman.cmd import Runner

lgr = logging.getLogger('niceman.ssh')
...
class SSHManager(object):
    ...
    def socket_dir(self):
        if self._socket_dir is None:
            # TODO: centralize AppDirs (=> niceman.config?)
            from appdirs import AppDirs
            self._socket_dir = AppDirs('niceman', 'niceman.org').user_config_dir
