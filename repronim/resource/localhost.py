...
#
# ## ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ##
"""Resource sub-class to provide access to the localhost."""

from repronim.resource.base import Resource


class LocalhostResource(Resource):
    ...
    def __init__(self, default_config={}, config={}):
        ...
        if not 'container' in default_config and not 'container' in config:
            default_config['container'] = 'localshell'

        super(LocalhostResource, self).__init__(default_config, config)
