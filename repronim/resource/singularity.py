...
#
# ## ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ##
"""Resource sub-class to provide access to singularity containers."""

from repronim.resource.base import Resource


class SingularityResource(Resource):
    ...
    def __init__(self, default_config={}, config={}):
        ...
        if not 'container' in default_config and not 'container' in config:
            default_config['container'] = 'singularity'

        super(SingularityResource, self).__init__(default_config, config)
