...
#
# ## ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ##
"""Test functioning of the repronim main cmdline utility """
...
def run_main(args, exit_code=0, expect_stderr=False):
    """Run main() of the repronim, do basic checks and provide outputs
...
def test_version():
    ...
    ok_startswith(out, 'repronim %s\n' % repronim.__version__)
    in_("Copyright", out)
...
def test_help_np():
    ...
    # enough of bin/repronim and .tox/py27/bin/repronim -- guarantee consistency! ;)
    ok_startswith(stdout, 'Usage: repronim')
    # Sections start/end with * if ran under REPRONIM_HELP2MAN mode
