    ...
    with (
        ...
        client.return_value = MagicMock(
            containers=lambda all: [
                {"Id": "326b0fdfbf83", "Names": ["/existing-test-resource"], "State": "running"},
                {"Id": "111111111111", "Names": ["/duplicate-resource-name"], "State": "running"},
                {"Id": "222222222222", "Names": ["/duplicate-resource-name"], "State": "running"},
            ],
        ...
        config = {"name": "non-existent-resource", "type": "docker-container"}
        ...
        config = {"name": "duplicate-resource-name", "type": "docker-container"}
        resource = resman.factory(config)
