        ...
        client.return_value = MagicMock(
            instances=MagicMock(
                filter=lambda Filters: [
                    MagicMock(instance_id="i-22221ddf096c22bb0", state={"Name": "running"}),
                    MagicMock(instance_id="i-3333f40de2b9b8967", state={"Name": "running"}),
                ]
            )
        )
        config = {
