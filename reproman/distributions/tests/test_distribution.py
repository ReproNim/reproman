...
contrib non-free' to /etc/apt/sources.list.d/reproman.sources.list",
            log.lines,
        )
        assert_in(
            "Adding line 'deb http://snapshot-neuro.debian.net:5002/archive/neurodebian/20171208T032012Z/ \
xenial main contrib non-free' to /etc/apt/sources.list.d/reproman.sources.list",
            log.lines,
        )
        assert_in(
            "Adding line 'deb http://snapshot-neuro.debian.net:5002/archive/neurodebian/20171208T032012Z/ \
...
dcm2niix=1:1.0.20171017+git3-g9ccc4c0-1~nd16.04+1",
            log.lines,
        )
