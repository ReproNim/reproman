...
requires["full-except-datalad"] = [v for k, vs in requires.items() for v in vs if k != "datalad"]
...
setup(
    ...
    cmdclass=cmdclass,
    package_data={
        "reproman": findsome(opj("distributions", "tests", "files"), {"yml", "yaml"})
        ...
        + findsome(opj("support", "jobs", "job_templates", "runscript"), {"sh"})
        + findsome(opj("support", "jobs", "job_templates", "runscript", "includes"), {"sh"})
        + findsome(opj("support", "jobs", "job_templates", "submission"), {"template"})
        + findsome(opj("support", "jobs", "job_templates", "cluster"), {"template"})
